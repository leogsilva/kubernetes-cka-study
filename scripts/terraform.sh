...
# This scripts creat4s a kubernetes cluster on google cloud
...
# call the bucket name function
get_bucket_name

# Initialize and run Terraform
(cd "$ROOT/terraform"; terraform init -input=false -backend-config "bucket=${BUCKET_NAME}")
